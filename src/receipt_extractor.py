...
_MONTH_NAME_TO_NUM = {
    ...
    "maerz": 3, "märz": 3, "march": 3, "mär": 3, "mrz": 3, "mar": 3,
    "april": 4, "apr": 4,
    "mai": 5, "may": 5,
    "juni": 6, "june": 6, "jun": 6,
    "juli": 7, "july": 7, "jul": 7,
...
_NAMED_DATE_RE = re.compile(
    r"\b(?P<day>\d{1,2})\.?\s+"
    r"(?P<month>Januar|January|Februar|February|März|Maerz|March|April|"
    r"Mai|May|Juni|June|Juli|July|August|September|Oktober|October|"
    r"November|Dezember|December|"
    r"Jan|Feb|Mär|Mrz|Mar|Apr|Jun|Jul|Aug|Sept|Sep|Okt|Oct|Nov|Dez|Dec)\s+"
    r"(?P<year>\d{4})\b",
    re.I,
)
_AMAZON_EU_RE = re.compile(r"Amazon(?:\s+Media)?\s+EU\b", re.I)
